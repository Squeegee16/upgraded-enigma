...
if command -v go >/dev/null 2>&1; then
    ...
    # Ensure Go cache directories are writable
    for go_dir in \
        "${GOPATH:-$HOME/go}" \
...
# This fixes: "server already running" errors
DISPLAY_NUM="99"
